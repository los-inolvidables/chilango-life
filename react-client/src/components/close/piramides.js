...
const Piramides =()=>{
  return(
    ...
    <br/>
    <br/>
    <h2>Teotihuacán pyramids</h2>
    <center><iframe className= "videos" className= "videos" width="560" height="315"
    src="https://www.youtube.com/embed/CDQ9Qi3itZc?autoplay=1&controls=0&&showinfo=0"
