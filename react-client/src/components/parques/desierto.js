...
const Desierto =()=>{
  return(
    ...
    <div>
      ...
      <br/>
      <br/>
      <h2>Dessert of the Lions Nacional park</h2>
        ...
        <p>The park's altitude varies between 2,600 and 3,700 meters above sea level, giving the area a relatively cold and damp climate. It is a forested area primarily with pines, oyamel firs and holm oaks with many brooks, ravines and waterfalls. The park is considered to be the oldest protected biosphere in Mexico. It was originally declared a forest reserve in 1876 by President Lerdo de Tejada with the intent of conserving its fresh water springs to supply Mexico City. It was later declared a national park on 27 November 1917, by President Venustiano Carranza.
        </p>
      </div>
    </div>
  );
