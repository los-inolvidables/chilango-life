...
const Papalote =()=>{
  return(
    ...
    <br/>
    <br/>
    <p>The museum Papalote Museo del Niño is located in Mexico City Bosques de Chapultepec.
    The museum is focused in learning, communication and working together through interactive
    expositions of science, technology and art for children.</p><p>The museum was created in 1993 by
